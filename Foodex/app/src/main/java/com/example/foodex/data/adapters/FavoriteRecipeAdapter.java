...
import com.example.foodex.data.models.Recipe;
...
public class FavoriteRecipeAdapter extends RecyclerView.Adapter<FavoriteRecipeViewHolder>{
    ...
    public FavoriteRecipeAdapter(Context context, List<Recipe> list, RecipeClickListener listener) {
    ...
    public FavoriteRecipeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new FavoriteRecipeViewHolder(LayoutInflater.from(context).inflate(R.layout.list_random_recipe, parent, false));
    }
