...
public final class ActivityLoginUserBinding implements ViewBinding {
  ...
  private ActivityLoginUserBinding(@NonNull ConstraintLayout rootView, @NonNull TextView banner,
  ...
  public static ActivityLoginUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginUserBinding((ConstraintLayout) rootView, banner, bannerDescription,
          email, forgotPassword, password, progressBar, register, signIn);
    }
