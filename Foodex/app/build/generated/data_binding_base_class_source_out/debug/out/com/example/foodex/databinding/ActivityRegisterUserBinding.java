...
public final class ActivityRegisterUserBinding implements ViewBinding {
  ...
  private ActivityRegisterUserBinding(@NonNull ConstraintLayout rootView, @NonNull TextView banner,
      @NonNull TextView bannerDescription, @NonNull EditText email, @NonNull EditText fullName,
      @NonNull EditText password, @NonNull ProgressBar progressBar, @NonNull Button registerUser) {
  ...
  public static ActivityRegisterUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterUserBinding((ConstraintLayout) rootView, banner, bannerDescription,
          email, fullName, password, progressBar, registerUser);
    }
